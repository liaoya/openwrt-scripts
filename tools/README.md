...
```bash
./ipkg-util.sh -s /work/openwrt/sdk/ar71xx -d /work/openwrt/package/21.02/ar71xx/ -o copy
...
./ipkg-util.sh -s /work/openwrt/sdk/mt7621 -d /work/openwrt/package21.02//mt7621/ -o copy
